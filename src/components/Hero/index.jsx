...
export default function Hero({ onContinue, ctaTitle }) {
    const [hero, setHero] = useState({
        ...
        subtitle:
            "Aaj ka din bhot special hai. ❤️ or Tum meri life ki sabse pyari muskaan ho. Hamesha isi tarah khush rehna aur muskuraate rehna. Happy Birthday, Meri Cutie. 🥰😍 I Love You So Much! ❤️",
    })
